...
/**
 * Factory for top-k window views.
 */
public class TopkWindowViewFactory implements ViewFactory{
    private final static String NAME = "Top-k";
    ...
    public View makeView(AgentInstanceViewFactoryChainContext agentInstanceViewFactoryContext) {
        ...
        return new TopkWindowView(this, uniqueCriteriaExpressions, uniqueEvals, sortCriteriaExpressions, sortEvals, isDescendingValues, sortWindowSize, randomAccess, rankedRandomAccess, useCollatorSort, agentInstanceViewFactoryContext);
    }
